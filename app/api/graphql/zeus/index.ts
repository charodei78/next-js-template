...
["DateTime"]:unknown;
	...
	created_at?:true,
	updated_at?:true,
	scenes?:ValueTypes["Scene"],
		__typename?: true
}>;
	["Query"]: AliasType<{
	users?:ValueTypes["User"],
user?: [{	id:string},ValueTypes["User"]],
	profile?:ValueTypes["User"],
	scenes?:ValueTypes["Scene"],
scene?: [{	id:string},ValueTypes["Scene"]],
		__typename?: true
}>;
	["Mutation"]: AliasType<{
createUser?: [{	input:ValueTypes["CreateUserInput"]},ValueTypes["User"]],
updateUser?: [{	input:ValueTypes["UpdateUserInput"]},ValueTypes["User"]],
removeUser?: [{	id:string},ValueTypes["User"]],
removeScene?: [{	id:string},ValueTypes["Scene"]],
		__typename?: true
}>;
	["CreateUserInput"]: {
	name:string,
...
["DateTime"]:any;
	...
	created_at:ModelTypes["DateTime"],
	updated_at:ModelTypes["DateTime"],
	scenes:ModelTypes["Scene"][]
};
	["Query"]: {
		users:ModelTypes["User"],
	user:ModelTypes["User"],
	profile:ModelTypes["User"],
	scenes:ModelTypes["Scene"][],
	scene:ModelTypes["Scene"]
};
	["Mutation"]: {
		createUser:ModelTypes["User"],
	updateUser:ModelTypes["User"],
	removeUser:ModelTypes["User"],
	removeScene:ModelTypes["Scene"]
};
...
["DateTime"]:any;
	...
	created_at: GraphQLTypes["DateTime"],
	updated_at: GraphQLTypes["DateTime"],
	scenes: Array<GraphQLTypes["Scene"]>
};
	["Query"]: {
	__typename: "Query",
	users: GraphQLTypes["User"],
	user: GraphQLTypes["User"],
	profile: GraphQLTypes["User"],
	scenes: Array<GraphQLTypes["Scene"]>,
	scene: GraphQLTypes["Scene"]
};
	["Mutation"]: {
	__typename: "Mutation",
	createUser: GraphQLTypes["User"],
	updateUser: GraphQLTypes["User"],
	removeUser: GraphQLTypes["User"],
	removeScene: GraphQLTypes["Scene"]
};
	["CreateUserInput"]: {
		name: string,
	email: string,
